 ...
 * public key. The daemon spells it `sha256:<base64url>` and OpenSSH spells it
 * `SHA256:<base64>`; the deploy flow compares them normalised. The older
 * `<scheme>://pair#offer=…` fragment stays supported as the fallback.
