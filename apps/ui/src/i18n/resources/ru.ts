  ...
  deviceAccess: {
    ...
    roles: {
      ...
      operator: {
        label: "Оператор",
        description:
          "Ведение работы: чаты агентов, терминалы, скрипты рабочей области, правка файлов, git и действия форджа. Без настроек хоста и без управления устройствами.",
      },
      viewer: {
        label: "Наблюдатель",
        description:
          "Только чтение: сессии, хронология, вывод терминала, просмотр файлов и различий. Без ввода и без выполнения команд.",
      },
    },
    refusal: {
