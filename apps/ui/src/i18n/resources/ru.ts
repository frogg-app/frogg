...
export const ru: TranslationResources = {
  ...
  settings: {
    ...
    about: {
      ...
      releaseChannel: {
        label: "Канал выпуска",
        stableHint: "Бета-версии — отдельное приложение {{beta}}, которое устанавливается рядом с этим",
        betaHint: "Эта бета-версия устанавливается рядом с {{stable}} и обновляется только до бета-версий",
        stable: "Стабильный",
        beta: "Бета",
      },
      updates: {
