...
export const ru: TranslationResources = {
  releaseStreams: {
    ...
    fetchFailed:
      "Не удалось получить данные с удалённых репозиториев ({{message}}). Показано то, что уже есть в этой копии.",
    stream: {
    ...
    setup: {
      ...
      description:
        "Бета-версии выходят из {{development}}, стабильные выпуски — из {{stable}}, которой ещё нет. Создайте её из последнего стабильного выпуска:",
    },
    flows: {
      ...
      counts: "Функции: {{features}} · Исправления: {{fixes}} · Прочее: {{other}}",
      ...
      forwardPort: {
        ...
        description:
          "Исправления, сделанные только в стабильной ветке. Перенесите их в разработку через cherry-pick, иначе продвижение их потеряет.",
      },
      sync: {
        title: "{{from}} → {{to}}: слить upstream",
        description:
          "Изменения upstream, которые ещё не слиты в вашу ветку разработки. Бета-сборка проверит их до того, как они дойдут до стабильных пользователей.",
      },
      contribute: {
        title: "{{from}} → {{to}}: предложить upstream",
        description:
          "Ваши изменения, которых нет в upstream. Верните продуктовые изменения, чтобы не поддерживать их самим.",
      },
    },
    changes: {
      title: "Изменения",
  ...
  newChat: {
    titles: {
      t1: "Что вы хотите узнать?",
      t2: "О чём думаете?",
      t3: "Спрашивайте что угодно.",
      t4: "Что разберём сегодня?",
      t5: "С чего начнём?",
      t6: "Есть вопрос?",
      t7: "Что вам интересно?",
      t8: "Над чем помочь подумать?",
      t9: "Во что углубимся?",
      t10: "Нужно второе мнение?",
      t11: "Над чем вы работаете?",
      t12: "Давайте разберёмся.",
    },
  ...
  settings: {
    ...
    about: {
      ...
      releaseChannel: {
        label: "Канал выпуска",
        stableHint:
          "Бета-версии — отдельное приложение {{beta}}, которое устанавливается рядом с этим",
        betaHint:
          "Эта бета-версия устанавливается рядом с {{stable}} и обновляется только до бета-версий",
        stable: "Стабильный",
        beta: "Бета",
      },
      updates: {
