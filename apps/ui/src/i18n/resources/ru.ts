  ...
  pairing: {
    ...
    deployHost: {
      ...
      network: {
        ...
        lan: "Сеть",
        tunnelHint:
          "Рекомендуется. Демон слушает только loopback, а приложение подключается к нему через SSH.",
        lanHint:
          "Демон слушает все интерфейсы на порту {{port}}, и это устройство связывается с ним по сети.",
      },
      steps: {
      ...
      skipped: "Пропущено: демон не выдал код связывания; хост проверяется SSH.",
      ...
      unverified:
        "Демон не выдал код связывания, поэтому подключение опирается только на ключ хоста SSH.",
    },
    networkScan: {
      searching: "Поиск…",
