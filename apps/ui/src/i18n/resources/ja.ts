...
export const ja: TranslationResources = {
  ...
  mobile: {
    updates: {
      status: {
        idle: "アプリ更新の状態はまだ確認されていません。",
        checking: "アプリの更新を確認しています...",
        downloading: "更新をダウンロードしています...",
        installing: "Android のインストーラーを待っています...",
        installed: "更新をインストールしました。",
        upToDate: "アプリは最新です。",
        available: "更新があります: {{version}}",
        failed: "アプリを更新できませんでした。",
      },
      ...
      permissionRequired:
        "システム設定で {{brandName}} に提供元不明のアプリのインストールを許可してから、もう一度更新を開始してください。",
      unsupported: "このビルドではアプリ内更新を利用できません。",
      section: {
        title: "更新",
        currentVersion: "現在のバージョン",
        source: "更新は GitHub のリリースからダウンロードされ、Android がインストールします。",
        autoCheck: {
          title: "自動で確認",
          hint: "アプリの起動ごとに新しいバージョンを確認します。",
        },
        check: "更新を確認",
        checking: "確認中...",
        neverChecked: "まだ確認していません。",
        ...
        installing: "インストール中...",
        installHint:
          "{{size}} の {{abi}} パッケージをダウンロードし、Android のインストーラーを開きます。",
        noAsset: "このデバイス向けのパッケージはまだ公開されていません。",
        signatureMismatch:
          "公開されているパッケージは別の鍵で署名されているため、Android はこのビルドに上書きインストールできません。リリースページから手動でインストールしてください。",
        installedHint: "自動で再起動しない場合は {{brandName}} を開き直してください。",
      },
      callout: {
        title: "更新があります",
        description: "{{version}} をダウンロードしてインストールできます。",
        whatsNew: "新着情報",
  ...
  deviceAccess: {
    ...
    roles: {
      ...
      operator: {
        label: "オペレーター",
        description:
          "作業の実行: エージェントのチャット、ターミナル、ワークスペーススクリプト、ファイル編集、git とフォージの操作。ホスト設定とデバイス管理はできません。コマンドはホストのユーザーとして実行されるため、ホスト上ではオーナーと同等です。",
      },
      viewer: {
        label: "ビューアー",
        description:
          "読み取り専用: セッション、タイムライン、ターミナル出力、ワークスペース内のファイル閲覧と差分。入力とコマンド実行はできません。",
      },
    },
    refusal: {
  ...
  pairing: {
    connectionMethods: {
      ...
      deploy: {
        title: "ホストにデプロイ",
        description: "SSH で接続できるマシンにデーモンをインストールします。",
      },
    },
    deployHost: {
      title: "ホストにデプロイ",
      helper:
        "標準のインストーラーで {{brandName}} デーモンを SSH 経由でインストールし、サービスを起動してこのデバイスをペアリングします。ホスト上で手作業は不要です。",
      tabs: { config: "SSH 設定", manual: "手動" },
      fields: {
        host: "ホスト",
        user: "ユーザー",
        sshPort: "SSH ポート",
      ...
      formErrors: {
        ...
        invalidHost: "ホストとユーザーは空白なしで入力してください。",
      ...
      errors: {
        ...
        claim_rejected:
          "ペアリングコードは使用済みか期限切れです。再試行して新しいコードを取得してください。",
        connect_failed: "デーモンに接続できませんでした。{{detail}}",
        cancelled: "キャンセルしました。ホストにはインストール済みの内容が残ります。",
      },
      actions: {
        deploy: "デプロイ",
        cancel: "キャンセル",
  ...
  subagents: {
    ...
    detachedToast: "{{name}} は独立したエージェントになりました",
    detachedToastUnnamed: "サブエージェントは独立したエージェントになりました",
