...
export const ptBR: TranslationResources = {
  ...
  sidebar: {
    ...
    chats: {
      ...
      noMatches: "Nenhum chat corresponde à busca",
      delete: "Excluir chat",
      groups: {
        today: "Hoje",
        yesterday: "Ontem",
  ...
  chats: {
    sandbox: {
      ...
      readAnywhere: "Pode ler arquivos em qualquer lugar desta máquina",
      writeChatOnly: "Só pode criar ou editar arquivos na própria pasta do chat",
      noShell: "Sem comandos de shell",
      noSkills: "Sem skills, plugins ou servidores MCP",
    },
    web: {
      label: "Web",
      description: "Permitir que este chat pesquise e carregue páginas da web",
      tooltip: "Ativar ou desativar o acesso à web",
    },
  },
  newChat: {
    titles: {
    ...
    errors: {
      ...
      unsupportedProvider: "Os chats ainda não podem usar este provedor. Escolha um modelo Claude.",
      createFailed: "Não foi possível criar o chat",
    },
  },
  newWorkspace: {
    title: "Nova sessão",
  ...
  mobile: {
    updates: {
      status: {
        idle: "O estado das atualizações ainda não foi verificado.",
        checking: "Procurando atualizações do aplicativo...",
        downloading: "Baixando a atualização...",
        installing: "Aguardando o instalador do Android...",
        installed: "Atualização instalada.",
        upToDate: "O aplicativo está atualizado.",
        available: "Atualização disponível: {{version}}",
        failed: "Não foi possível atualizar o aplicativo.",
      },
      checkFailed: "Não foi possível procurar atualizações: {{message}}",
      downloadFailed: "Falha no download: {{message}}",
      downloadCancelled: "O download foi cancelado.",
      installFailed: "Falha na instalação: {{message}}",
      installCancelled: "Instalação cancelada.",
      permissionRequired:
        "Permita a instalação de apps desconhecidos para o {{brandName}} nas configurações do sistema e inicie a atualização novamente.",
      unsupported: "As atualizações dentro do aplicativo não estão disponíveis nesta versão.",
      section: {
        title: "Atualizações",
        currentVersion: "Versão atual",
        source:
          "As atualizações são baixadas das versões publicadas no GitHub e instaladas pelo Android.",
        autoCheck: {
          title: "Verificar automaticamente",
          hint: "Procurar uma versão mais recente sempre que o aplicativo iniciar.",
        },
        ...
        downloading: "Baixando {{progress}}",
        installing: "Instalando...",
        installHint: "Baixa o pacote {{abi}} de {{size}} e abre o instalador do Android.",
        noAsset: "Nenhum pacote foi publicado para este dispositivo ainda.",
        signatureMismatch:
          "O pacote publicado está assinado com outra chave, então o Android não consegue instalá-lo sobre esta versão. Instale-o manualmente pela página da versão.",
        installedHint: "Abra o {{brandName}} novamente se ele não reiniciar sozinho.",
      },
      callout: {
        title: "Atualização disponível",
        description: "{{version}} está pronta para baixar e instalar.",
        whatsNew: "Novidades",
  ...
  downloads: {
    ...
    browserUnavailable: "Os downloads não estão disponíveis neste navegador.",
    noDirectory: "Não há uma pasta de downloads com permissão de escrita.",
  ...
  subagents: {
    ...
    detachedToast: "{{name}} agora é um agente independente",
    detachedToastUnnamed: "O subagente agora é um agente independente",
  ...
  settings: {
    ...
    host: {
      ...
      providerAccounts: {
        ...
        nameHint: "Letras minúsculas, dígitos e hífens simples.",
        nameInvalid: "Use letras minúsculas, dígitos e hífens simples.",
        nameDuplicate: "Já existe uma conta chamada “{{slug}}”.",
        slugPreview: "Identificador: {{slug}}",
        configDirPreview: "Diretório de configuração: {{path}}",
        configDirEnvHint: "Aplicado por {{env}} enquanto esta conta estiver ativa.",
        sharedFoldersLabel: "Pastas compartilhadas",
        sharedFoldersHint:
      ...
      settingsModal: {
        ...
        accounts: {
          ...
          signOutConfirmMessage:
            "Exclui as credenciais salvas desta conta no servidor. A conta e sua pasta são mantidas.",
          export: "Exportar",
          exportTitle: "Exportar contas",
          exportWarning:
            "Este pacote contém credenciais de login ativas em texto puro. Quem o obtiver pode usar estas contas. Trate-o como uma senha: cole-o apenas no servidor de destino e não o armazene nem compartilhe.",
          exportCopy: "Copiar pacote",
          exportCopied: "Copiado",
          exportPending: "Preparando a exportação…",
          exportEmpty: "Não há nada para exportar.",
          importAction: "Importar",
          importTitle: "Importar contas",
          importHint:
            "Cole um pacote exportado de outro servidor. Ele contém credenciais ativas, portanto trate-o como uma senha.",
          importPlaceholder: "Cole o JSON do pacote",
          importSubmit: "Importar",
          importInvalid: "Esse não é um pacote de contas válido.",
        },
        models: {
          title: "Modelos",
