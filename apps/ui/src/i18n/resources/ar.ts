  ...
  deviceAccess: {
    ...
    roles: {
      ...
      operator: {
        label: "المشغّل",
        description:
          "إدارة العمل: محادثات الوكلاء، والطرفيات، وبرامج مساحة العمل، وتحرير الملفات، وإجراءات git والمنصّة. بدون إعدادات المضيف وبدون إدارة الأجهزة.",
      },
      viewer: {
        label: "المشاهد",
        description:
          "للقراءة فقط: الجلسات، والمسارات الزمنية، ومخرجات الطرفية، وتصفّح الملفات والفروق. بدون إدخال وبدون تنفيذ أوامر.",
      },
    },
    refusal: {
