  ...
  settings: {
    ...
    host: {
      ...
      providerAccounts: {
        ...
        noEnabledProviders: "لا يدعم أي مزوّد على هذا المضيف تعدد الحسابات.",
        ...
        notAuthenticated: "لم يُسجّل الدخول",
    ...
    providers: {
      ...
      settingsModal: {
        ...
        accounts: {
          title: "الحسابات",
          info: "سجّل الدخول بأكثر من حساب واختر الحساب الذي يعمل به هذا المزود.",
          empty: "لا توجد حسابات بعد.",
          usageTitle: "الاستخدام",
          usageInfo: "يُبلّغ المزود عن الاستخدام للمزود بالكامل، وليس لكل حساب.",
          rename: "إعادة التسمية",
          renameTitle: "إعادة تسمية الحساب",
          renamePlaceholder: "اسم الحساب",
          renameHint: "يغيّر التسمية فقط. لا يُنقل أي شيء على القرص ويبقى تسجيل الدخول كما هو.",
        ...
        models: {
          title: "الطُرز",
          info: "قيّد الطُرز التي يمكن للحساب تشغيلها من هذا المزود.",
          empty: "لم يُبلّغ هذا المزود عن أي طُرز.",
          accountLabel: "الحساب",
          unrestricted: "كل الطُرز",
          none: "لا طُرز",
          restrictedCount: "{{allowed}} من {{total}} طُرز",
          allowAll: "السماح بكل الطُرز",
          allowNone: "عدم السماح بأي طراز",
          restrictionHint: "الحساب غير المقيّد يمكنه تشغيل كل طراز يوفره هذا المزود.",
          selectAccount: "اختر حسابًا لتقييده.",
        },
      },
      statuses: {
        disabled: "عاجز",
