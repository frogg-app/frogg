...
export const ko: TranslationResources = {
  ...
  mobile: {
    updates: {
      status: {
        idle: "앱 업데이트 상태를 아직 확인하지 않았습니다.",
        checking: "앱 업데이트를 확인하는 중...",
        downloading: "업데이트를 내려받는 중...",
        installing: "Android 설치 관리자를 기다리는 중...",
        installed: "업데이트를 설치했습니다.",
        upToDate: "앱이 최신 상태입니다.",
        available: "업데이트 있음: {{version}}",
        failed: "앱을 업데이트하지 못했습니다.",
      },
      checkFailed: "업데이트를 확인하지 못했습니다: {{message}}",
      downloadFailed: "내려받기에 실패했습니다: {{message}}",
      downloadCancelled: "내려받기를 취소했습니다.",
      installFailed: "설치에 실패했습니다: {{message}}",
      installCancelled: "설치를 취소했습니다.",
      permissionRequired:
        "시스템 설정에서 {{brandName}}에 출처를 알 수 없는 앱 설치를 허용한 뒤 업데이트를 다시 시작하세요.",
      unsupported: "이 빌드에서는 앱 내 업데이트를 사용할 수 없습니다.",
      section: {
        title: "업데이트",
        currentVersion: "현재 버전",
        source: "업데이트는 GitHub 릴리스에서 내려받아 Android가 설치합니다.",
        autoCheck: {
          title: "자동으로 확인",
          hint: "앱을 시작할 때마다 새 버전을 확인합니다.",
        },
        check: "업데이트 확인",
        checking: "확인 중...",
        neverChecked: "아직 확인하지 않았습니다.",
        ...
        releaseNotes: "새로운 기능",
        viewOnGithub: "GitHub에서 보기",
        downloadAndInstall: "내려받아 설치",
        downloading: "내려받는 중 {{progress}}",
        installing: "설치 중...",
        installHint: "{{size}} 크기의 {{abi}} 패키지를 내려받고 Android 설치 관리자를 엽니다.",
        noAsset: "이 기기용 패키지가 아직 공개되지 않았습니다.",
        signatureMismatch:
          "공개된 패키지가 다른 키로 서명되어 Android가 이 빌드 위에 설치할 수 없습니다. 릴리스 페이지에서 직접 설치하세요.",
        installedHint: "자동으로 다시 시작되지 않으면 {{brandName}}을 다시 열어 주세요.",
      },
      callout: {
        title: "업데이트 있음",
        description: "{{version}}을 내려받아 설치할 수 있습니다.",
        whatsNew: "새로운 기능",
        install: "내려받아 설치",
        installing: "설치 중...",
      },
  ...
  deviceAccess: {
    ...
    loading: "기기를 불러오는 중…",
    empty: "이 호스트에 페어링된 기기가 아직 없습니다.",
    staleSnapshot: "이 목록은 최신이 아닐 수 있습니다.",
    staleAfterError: "마지막으로 불러온 목록을 표시합니다. 새로 고칠 수 없었습니다.",
    thisDevice: "이 기기",
    unnamedDevice: "이름 없는 기기",
    renameLabel: "기기 이름",
    callerRole: {
      title: "내 접근 권한",
      unknown: "이 호스트가 무엇을 허용하는지 응답을 기다리는 중입니다.",
      unsupported: "이 호스트는 기기 역할을 사용하지 않습니다.",
      noCredential: "이 연결에는 기기 자격 증명이 없어서 호스트가 소유자로 취급합니다.",
    },
    roles: {
      owner: {
        label: "소유자",
        description:
          "모든 권한: 호스트 설정, 공급자 계정, 페어링 코드, 그리고 기기 승인·해지·역할 변경.",
      },
      operator: {
        label: "운영자",
        description:
          "작업 진행: 에이전트 대화, 터미널, 워크스페이스 스크립트, 파일 편집, git 및 포지 작업. 호스트 설정과 기기 관리는 불가. 명령이 호스트 사용자로 실행되므로 호스트에서는 소유자와 같음.",
      },
      viewer: {
        label: "뷰어",
        description:
          "읽기 전용: 세션, 타임라인, 터미널 출력, 워크스페이스 안의 파일 탐색과 diff. 입력과 명령 실행은 불가.",
      },
    },
    refusal: {
      unknown: "이 호스트가 지원 항목을 알려줄 때까지 기다리는 중입니다.",
      unsupported:
        "이 호스트는 너무 오래되어 기기를 관리할 수 없습니다. 사용하려면 업데이트하세요.",
      role: "기기를 변경할 수 있는 것은 소유자뿐입니다. 이 기기는 {{role}}입니다.",
      roleCode: "페어링 코드를 만들 수 있는 것은 소유자뿐입니다. 이 기기는 {{role}}입니다.",
    },
    actions: {
      rename: "이름 변경",
      revoke: "해지",
      revokeThisDevice: "이 기기 해지",
      save: "저장",
      cancel: "취소",
      retry: "다시 시도",
      back: "뒤로",
    ...
    lastSeen: {
      ...
      never: "연결한 적 없음",
      justNow: "방금 전 접속",
      minutes_one: "{{count}}분 전 접속",
      minutes_other: "{{count}}분 전 접속",
      hours_one: "{{count}}시간 전 접속",
      hours_other: "{{count}}시간 전 접속",
      days_one: "{{count}}일 전 접속",
      days_other: "{{count}}일 전 접속",
    },
    errors: {
      unknownDevice: "그 기기는 더 이상 페어링되어 있지 않습니다.",
      invalidName: "기기 이름은 1자에서 {{max}}자 사이여야 합니다.",
      noPairingCode: "호스트가 페어링 코드를 반환하지 않았습니다.",
    },
    revoke: {
      title: "{{name}}을(를) 해지할까요?",
      message:
        "{{name}}은(는) 즉시 접근 권한을 잃고 연결이 끊깁니다. 나중에 다시 페어링할 수 있습니다.",
      selfTitle: "이 기기를 해지할까요?",
      selfMessage:
        "지금 사용 중인 기기입니다. 해지하면 이 세션이 즉시 종료되고, 돌아오려면 다시 페어링해야 합니다.",
      lastOwnerWarning:
        "마지막 소유자입니다. 해지하면 앱에서 이 호스트를 관리할 수 있는 사람이 없어지고, 호스트의 셸에서 페어링을 초기화해야 합니다.",
      done: "{{name}}을(를) 해지했습니다.",
    },
    role: {
      change: "역할 변경",
      done: "{{name}}은(는) 이제 {{role}}입니다.",
      lastOwnerTitle: "이 호스트를 소유자 없이 둘까요?",
      lastOwnerMessage:
        "{{name}}이(가) 마지막 소유자입니다. 이후에는 아무도 앱에서 호스트를 관리할 수 없습니다.",
      selfDemoteTitle: "내 접근 권한을 포기할까요?",
      selfDemoteMessage: "이 기기는 바로 {{role}}이(가) 되고, 여기서 기기 관리 권한을 잃습니다.",
    },
    requests: {
      title: "승인 대기 중",
      loading: "페어링 요청을 확인하는 중…",
      empty: "입장을 기다리는 기기가 없습니다.",
      untrustedName: "이 이름은 참가를 요청한 기기가 직접 정한 것입니다.",
      matchCode: "대조 코드: {{code}}",
      from: "{{address}}에서",
      roleLabel: "다음 역할로 승인",
      approve: "승인",
      deny: "거부",
      approved: "{{name}}을(를) 승인했습니다.",
      denied: "{{name}}을(를) 거부했습니다.",
    },
    code: {
      title: "페어링 코드",
      roleLabel: "새 기기의 역할",
      generate: "페어링 코드 생성",
      regenerate: "새 코드 생성",
      ownerWarning: "소유자 코드는 새 기기에 이 호스트의 모든 제어 권한을 줍니다.",
      expiresIn: "{{time}} 후 만료",
      expired: "이 코드는 만료되었습니다. 새 코드를 생성하세요.",
      fingerprint: "키 지문: {{fingerprint}}",
      fingerprintHint: "페어링 전에 상대 기기가 일치를 확인할 수 있도록 이 값을 읽어 주세요.",
      qrAccessibility: "페어링 링크의 QR 코드",
      qrLoading: "QR 코드를 만드는 중…",
      qrUnavailable: "QR 코드를 만들 수 없습니다. 대신 코드나 링크를 사용하세요.",
      copyCode: "코드 복사",
      copyLink: "링크 복사",
      hide: "숨기기",
      securityWarning:
        "이 코드를 얻은 사람은 만료될 때까지 이 호스트에 기기를 페어링할 수 있습니다.",
    },
    entry: {
      title: "페어링 코드 입력",
      subtitle: "소유자가 발급해 준 코드를 입력하세요.",
      hostLabel: "호스트 주소",
      hostPlaceholder: "192.168.1.20:9999",
      codeLabel: "페어링 코드",
      useTls: "TLS로 연결",
      verify: "이 호스트 확인",
      verifying: "호스트의 신원을 확인하는 중…",
      verified: "이 호스트가 자신의 키를 보유하고 있음을 증명했습니다.",
      compareFingerprint: "페어링하기 전에 이 지문이 소유자 화면의 지문과 일치하는지 확인하세요.",
      pair: "페어링",
      paired: "{{name}}과(와) 페어링했습니다.",
      problems: {
        host_required: "호스트 주소를 입력하세요.",
        port_invalid: "그 포트는 유효하지 않습니다.",
        code_incomplete: "페어링 코드는 여덟 자입니다.",
        code_invalid: "유효한 페어링 코드가 아닙니다.",
      },
      refused: {
        unreachable: "호스트가 응답하지 않았습니다",
        fingerprint_mismatch: "이 코드의 대상 호스트가 아닙니다",
        proof_invalid: "호스트가 키 보유를 증명하지 못했습니다",
        server_key_changed: "이 호스트는 이미 다른 키로 등록되어 있습니다",
      },
    },
  },
  pairConfirm: {
    title: "이 호스트와 페어링할까요?",
    titleClaim: "이 호스트의 소유권을 가져올까요?",
    claimWarning: {
      title: "이렇게 하면 내가 소유자가 됩니다",
      body: "소유권을 가져오면 이 기기가 그 머신과 에이전트를 모두 제어하게 됩니다. 직접 시작한 경우에만 계속하세요.",
    },
    fields: {
      address: "주소",
      hostname: "이름",
      fingerprint: "호스트 키 지문",
      expires: "링크 만료",
      role: "이 기기의 역할",
      serverId: "서버 ID",
    },
    ...
    verify: {
      pending: "호스트의 신원을 확인하는 중…",
      verifiedTitle: "신원 확인됨",
      verifiedBody: "이 주소의 호스트가 위 지문에 해당하는 키를 보유하고 있음을 증명했습니다.",
      unreachableTitle: "호스트가 응답하지 않았습니다",
      refusedTitle: "거부됨: 링크가 가리키는 호스트가 아닙니다",
      reasons: {
        fingerprintMismatch: "호스트의 키가 링크의 지문과 일치하지 않습니다. 계속하지 마세요.",
        proofInvalid: "호스트가 자신의 키를 보유하고 있음을 증명하지 못했습니다. 계속하지 마세요.",
        keyChanged:
          "이 서버는 이미 다른 키로 등록되어 있습니다. 호스트를 다시 설치했거나, 무언가가 호스트를 사칭하고 있습니다.",
      },
    },
    expiredTitle: "이 링크는 만료되었습니다",
    expiredBody: "새 페어링 링크를 요청해 다시 시도하세요.",
    errorTitle: "페어링 실패",
    invalidTitle: "알 수 없는 페어링 링크",
    invalidBody: "이 링크는 이 앱이 이해하는 페어링 링크가 아닙니다.",
    actions: {
      pair: "페어링",
      claim: "이 호스트 소유권 가져오기",
      cancel: "취소",
  ...
  presence: {
    ...
    activity: {
      ...
      typing: "{{name}}이(가) 입력 중",
      sending: "{{name}}이(가) 보내는 중",
    ...
    providers: {
      ...
      settingsModal: {
        ...
        account: {
          ...
          noModels: "이 프로바이더가 보고한 모델이 없습니다.",
          noThinking: "이 모델에는 사고 수준이 없습니다.",
          modelsTitle: "모델 사용 권한",
          modelsDescription: "이 계정이 실행할 수 있는 프로바이더 모델입니다.",
          allModels: "모든 모델",
          noModelsAllowed: "모델 없음",
          someModels: "모델 {{total}}개 중 {{allowed}}개",
          allowAll: "모든 모델 허용",
          systemPromptTitle: "시스템 프롬프트",
          systemPromptDescription:
            "이 계정으로 실행한 모든 에이전트의 시스템 프롬프트에 추가됩니다.",
          systemPromptPlaceholder: "이 계정의 모든 에이전트가 따를 지침을 추가하세요",
          systemPromptTooLong: "{{max}}자 이내로 입력하세요.",
          saved: "저장됨",
          revert: "되돌리기",
          save: "저장",
          identityTitle: "표시",
          nickname: "표시 이름",
          nicknameHint: "이름표만 바뀝니다. 디스크의 내용은 이동하지 않고 로그인도 유지됩니다.",
          nicknameInvalid: "이름을 입력하세요.",
          color: "색상",
          transferTitle: "이 계정 옮기기",
          transferDescription: "이 로그인을 다른 호스트로 복사하거나 다른 곳에서 가져옵니다.",
          dangerTitle: "위험 구역",
          signOutDescription:
            "호스트에 저장된 이 계정의 자격 증명을 삭제합니다. 계정은 유지됩니다.",
          deleteTitle: "계정 삭제",
          deleteDescription: "호스트에서 계정과 설정 디렉터리를 제거합니다. 되돌릴 수 없습니다.",
          delete: "삭제",
        },
        accounts: {
          signOut: "로그아웃",
          signOutConfirmTitle: "{{name}}을(를) 로그아웃할까요?",
          signOutConfirmMessage:
            "서버에 저장된 이 계정의 자격 증명을 삭제합니다. 계정과 폴더는 유지됩니다.",
          export: "내보내기",
          exportTitle: "계정 내보내기",
          exportWarning:
            "이 번들에는 사용 가능한 로그인 자격 증명이 평문으로 들어 있습니다. 번들을 가진 사람은 누구나 이 계정을 쓸 수 있습니다. 비밀번호처럼 다루세요. 옮겨 갈 서버에만 붙여넣고 저장하거나 공유하지 마세요.",
          exportCopy: "번들 복사",
          exportCopied: "복사했습니다",
          exportPending: "내보내기 준비 중…",
          exportEmpty: "내보낼 것이 없습니다.",
          importAction: "가져오기",
          importTitle: "계정 가져오기",
          importHint:
            "다른 서버에서 내보낸 번들을 붙여넣으세요. 사용 가능한 자격 증명이 들어 있으므로 비밀번호처럼 다뤄야 합니다.",
          importPlaceholder: "번들 JSON 붙여넣기",
          importSubmit: "가져오기",
          importInvalid: "유효한 계정 번들이 아닙니다.",
        },
        models: {
          title: "모델",
          empty: "이 프로바이더가 보고한 모델이 없습니다.",
        },
        version: {
          title: "버전",
          badge: "업데이트",
          ...
          updating: "업데이트 중…",
          refresh: "새로 고침",
          autoUpdate: "자동으로 업데이트",
          autoUpdateDescription: "프로바이더의 새 릴리스가 게시되면 백그라운드에서 설치합니다.",
          status: {
            "up-to-date": "최신 상태",
