  ...
  settings: {
    ...
    providers: {
      ...
      settingsModal: {
        ...
        accounts: {
          title: "계정",
          info: "여러 계정으로 로그인하고 이 프로바이더를 실행할 계정을 선택합니다.",
          empty: "아직 계정이 없습니다.",
          usageTitle: "사용량",
          usageInfo: "사용량은 계정별이 아니라 프로바이더 전체로 보고됩니다.",
          rename: "이름 변경",
          renameTitle: "계정 이름 변경",
          renamePlaceholder: "계정 이름",
          renameHint: "이름표만 바뀝니다. 디스크의 내용은 이동하지 않고 로그인도 유지됩니다.",
          signOut: "로그아웃",
        ...
        models: {
          title: "모델",
          info: "계정이 사용할 수 있는 이 프로바이더의 모델을 제한합니다.",
          empty: "이 프로바이더가 보고한 모델이 없습니다.",
          accountLabel: "계정",
          unrestricted: "모든 모델",
          none: "모델 없음",
          restrictedCount: "모델 {{total}}개 중 {{allowed}}개",
          allowAll: "모든 모델 허용",
          allowNone: "아무 모델도 허용하지 않음",
          restrictionHint:
            "제한이 없는 계정은 이 프로바이더가 제공하는 모든 모델을 사용할 수 있습니다.",
          selectAccount: "제한할 계정을 선택하세요.",
        },
      },
      statuses: {
        disabled: "비활성화됨",
