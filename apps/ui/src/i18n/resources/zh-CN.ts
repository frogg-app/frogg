...
export const zhCN: TranslationResources = {
  ...
  workspace: {
    ...
    browser: {
      unavailable: {
        title: "浏览器仅桌面端可用",
        subtitle: "在 Electron 中打开此 会话 以使用内置浏览器。",
      },
    ...
    header: {
      ...
      toasts: {
        workspacePathUnavailable: "会话 路径尚不可用",
        branchNameUnavailable: "分支名称不可用",
        terminalQueued: "正在准备 会话，Terminal 准备好后会打开...",
        workspacePathCopiedLabel: "会话 路径",
    ...
    git: {
      actions: {
        ...
        mergeBranch: {
          ...
          moved: "Merged and moved to the target 会话",
          reused: "Merged; opened the existing target 会话",
          partial: "Merged, but the source 会话 could not be archived",
          conflict: "Merge conflict; the source 会话 was kept",
          failed: "Merge failed; the source 会话 was kept",
        },
        mergeFromBase: {
          label: "从 {{baseRef}} 更新",
          pending: "正在更新...",
        ...
        unavailable: {
          ...
          archiveNotWorktree: "此处无法归档，因为此 会话 不是作为 {{brandName}} worktree 创建的",
        ...
        archiveWarning: {
          ...
          confirm: "归档",
          cancel: "取消",
          consequence: "这会从侧边栏移除该 会话。若要稍后恢复，请打开历史记录。",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        showMore: "显示更多",
        showLess: "收起",
        createWorkspaceFor: "为 {{projectName}} 新建 会话",
        copyPath: "复制路径",
        copyBranchName: "复制分支名称",
        rename: "重命名 会话",
        pin: "置顶",
      ...
      toasts: {
        workspacePathUnavailable: "会话 路径不可用",
        pathCopied: "路径已复制",
  ...
  workspaceSetup: {
    ...
    errors: {
      ...
      selectModel: "请选择模型",
      hostDisconnected: "Host 未连接",
      pendingRequired: "没有待处理的 会话 setup",
  ...
  providerSelection: {
    ...
    readiness: {
      ...
      workspaceDirectoryNotFound: "会话 目录未找到",
      hostDisconnected: "Host 未连接",
    },
  },
  pairing: {
  ...
  settings: {
    ...
    shortcuts: {
      ...
      help: {
        ...
        jumpToWorkspace: "跳转到 会话",
        jumpToTab: "跳转到标签",
        previousWorkspace: "上一个 会话",
        nextWorkspace: "下一个 会话",
        previousTab: "上一个标签",
        nextTab: "下一个标签",
    ...
    host: {
      ...
      providerAccounts: {
        ...
        empty: "尚无登录",
        noEnabledProviders: "此主机上没有支持多个登录的提供商。",
        addAccount: "添加账户",
    ...
    providers: {
      ...
      settingsModal: {
        ...
        accounts: {
          title: "账号",
          info: "可以登录多个账号，并选择此提供方以哪个账号运行。",
          empty: "暂无账号。",
          usageTitle: "用量",
          usageInfo: "提供方按整体上报用量，而不是按账号上报。",
          rename: "重命名",
          renameTitle: "重命名账号",
          renamePlaceholder: "账号名称",
          renameHint: "仅修改名称。磁盘上的内容不会移动，登录状态也会保留。",
          signOut: "退出登录",
        ...
        models: {
          title: "模型",
          info: "限制账号可以使用此提供方的哪些模型。",
          empty: "此提供方未上报任何模型。",
          accountLabel: "账号",
          unrestricted: "所有模型",
          none: "无模型",
          restrictedCount: "{{total}} 个模型中的 {{allowed}} 个",
          allowAll: "允许所有模型",
          allowNone: "不允许任何模型",
          restrictionHint: "未受限的账号可以使用此提供方提供的所有模型。",
          selectAccount: "选择要限制的账号。",
        },
      },
      statuses: {
        disabled: "已禁用",
