...
export const en = {
  ...
  settings: {
    ...
    host: {
      ...
      providerAccounts: {
        sectionTitle: "Provider sign-ins",
        sectionInfo:
        ...
        noEnabledProviders: "No provider on this host supports multiple sign-ins.",
    ...
    providers: {
      ...
      settingsModal: {
        ...
        accounts: {
          title: "Accounts",
          info: "Sign in more than once and choose which account this provider runs as.",
          empty: "No accounts yet.",
          usageTitle: "Usage",
          usageInfo: "The provider reports usage for the whole provider, not per account.",
          rename: "Rename",
          renameTitle: "Rename account",
          renamePlaceholder: "Account name",
          renameHint: "Changes the label only. Nothing on disk is moved and the sign-in is kept.",
          signOut: "Sign out",
        ...
        models: {
          title: "Models",
          info: "Restrict which of this provider's models an account may run.",
          empty: "This provider reported no models.",
          accountLabel: "Account",
          unrestricted: "All models",
          none: "No models",
          restrictedCount: "{{allowed}} of {{total}} models",
          allowAll: "Allow all models",
          allowNone: "Allow none",
          restrictionHint: "An unrestricted account may run every model this provider offers.",
          selectAccount: "Choose an account to restrict.",
        },
      },
      statuses: {
        disabled: "Disabled",
